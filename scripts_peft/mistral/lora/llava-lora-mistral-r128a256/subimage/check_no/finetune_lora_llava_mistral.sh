...
CUDA_VISIBLE_DEVICES=0,1,2,3 deepspeed --include localhost:"$GPU_IDS" --master_port 29604\
    ...
    --data_path data/peft/check_no/check_no_dataset_subimage.json \
    ...
    --bf16 False \
    --fp16 True \
    --output_dir scripts_peft/mistral/lora/llava-lora-mistral-r128a256/subimage/check_no/llava-lora-mistral-r128a256-10BS-model \
    --num_train_epochs 1 \
