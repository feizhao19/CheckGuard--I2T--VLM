...
CUDA_VISIBLE_DEVICES=0,1,2,3 deepspeed --include localhost:"$GPU_IDS" --master_port 29606\
    ...
    --data_path data/peft/drawer/drawer_dataset.json \
    ...
    --bf16 False \
    --fp16 True \
    --output_dir scripts_peft/mistral/lora/llava-lora-mistral-r128a256/wholeimage/drawer/llava-lora-mistral-r128a256-10BS-model \
    --num_train_epochs 1 \
